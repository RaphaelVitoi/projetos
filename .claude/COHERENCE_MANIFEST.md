...
**Data:** 2026-03-12 | **Versão:** 1.0 | **Responsável:** @maverick (verificação contínua)

---

## O Compromisso

Cada um dos **14 agentes** funciona como parte de um **ecossistema coeso e harmônico**, não isolado. Nenhum agente:
...
### Camada 2: INSTRUÇÕES DO PROJETO GLOBAIS

**Arquivo:** `GLOBAL_INSTRUCTIONS.md`

Todos os 14 agentes absorvem:

- ✅ Pipeline harmônica completa (6 linear + 4 consultivo + 4 operacional)
- ✅ Filosofia operacional (harmonia, simetria, potencialização, fractalidade)
- ✅ Tabela de integração com entrada/saída/tipo/bloqueador de cada um
- ✅ Regras de projeto (linguagem, estilo, curadoria, autonomia)
- ✅ Resultado esperado (produto ético, inovador, defensável, entregue no timing)
...
- ✅ Domínio e público-alvo (site diverso, Raphael + alunos/clientes)
...
Cada um dos 14 agentes tem:

- ✅ Perfil próprio (autoridade, escopo, competências)
- ✅ Inteligência acumulada (padrões observados, precedentes, insights)
- ✅ Relacionamentos mapeados (com quem trabalha, quem consulta)
- ✅ Referência de integração harmônica (apontando volta para project-context + GLOBAL_INSTRUCTIONS + CLAUDE.md)
- ✅ Status operacional (quando ativado, histórico de tarefas)

---

## Os 14 Agentes & Sua Integração
...
## Garantias de Harmonia

### ✅ NINGUÉM ESTÁ ISOLADO

- [ ] Cada agente sabe sua entrada/saída
- [ ] Cada agente sabe quem vem antes/depois
- [ ] Cada agente sabe quem é consultado em paralelo
- [ ] Cada agente sabe que pode consultar qualquer um dos 14
...
- [ ] @skillmaster sincroniza MEMORY dos 14 agentes a cada hora
- [ ] Nenhuma inteligência acumulada é perdida
- [ ] Padrões observados são compartilhados

### ✅ AUTORIDADE CLARA

- [ ] @maverick é transversal (integra todos, toma decisões críticas você ausente)
- [ ] @auditor é único bloqueador linear (FASE 3)
- [ ] Nenhum agente sobrepõe autoridade de outro inadequadamente
- [ ] Consultorias paralelas influenciam sem bloquear

---

## Verificação Contínua

**@maverick** monitora esta coerência permanentemente. Se detecta:

- ❌ Agente documentado em agents/ mas não em MEMORY.md
- ❌ Agente em MEMORY.md mas não em project-context.md
- ❌ Inconsistência de papel entre documentos
- ❌ Agente isolado (sem relacionamentos mapeados)

**Ação:** Sinaliza e corrige IMEDIATAMENTE.
