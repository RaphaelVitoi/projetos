...
2.  **Pipeline de Ingestao:** Verifique se o protocolo `python task_executor.py ingest <arquivo>` esta documentado como o metodo para fechar o loop de friccao (O antigo do.ps1 -Ingest nao existe mais).
