...
- 37.5% linear é apropriado (workflow precisa de sequência clara)
- 31.25% consultivo deixa espaço para qualidade sem paralisar
- 25% operacional é suficiente para gestão de demanda e de contexto
- 6.25% intelectual (1 agente elite) é eficiente (não diluir liderança)
...
ORQUESTRADORES (Suporte & Fluxo):
  ...
  ✅ @bibliotecario — Sintetiza contexto para contornar gargalos de token
```
...
| Dimensão                | Limitação                                                  |
| ----------------------- | ---------------------------------------------------------- |
| **Agentes adicionados** | +2-3 agentes = redesign necessário (perde simplicidade 16) |
...
2. ✅ **@curator Elevado:** O agente atua agora com autoridade de _Soft Blocker_ nos lançamentos finais, salvaguardando a ética.
...
- 15 agentes bem-capazes, alinhados com responsabilidades
