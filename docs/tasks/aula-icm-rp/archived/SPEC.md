...
| 12 | INFO | PRD/SPEC | Uso de acentos inconsistente em caminhos de arquivo (heuristicas vs heurísticas) reflete o filesystem real | Nenhuma correcao necessaria |
...
- Relacao com SPR (Stack-to-Pot Ratio): SPR alto = RP distribuido por mais streets = decisoes menos catastróficas individualmente. SPR baixo = RP concentrado = cada decisao carrega peso desproporcional.
